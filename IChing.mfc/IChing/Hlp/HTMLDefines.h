...
#define HID_PANEPROPERTIES_CATEGORIZED          0x17530
#define HID_PANEPROPERTIES_ALPHABETIC           0x17531
#define HID_PANEPROPERTIES_PAGES                0x17532
#define HID_HEXAGRAM_FIRST                      0x17918
#define HID_HEXAGRAM_PREVIOUS                   0x17919
#define HID_HEXAGRAM_NEXT                       0x1791A
#define HID_HEXAGRAM_LAST                       0x1791B
#define HID_TEXT_BACK                           0x1797C
#define HID_TEXT_FORWARD                        0x1797D
#define HID_VSCTX_FIRST                         0x180E8
#define HID_VSCTX_PREVIOUS                      0x180E9
#define HID_VSCTX_NEXT                          0x180EA
#define HID_VSCTX_LAST                          0x180EB
#define HID_VSCTX_INVERSE                       0x180EC
#define HID_VSCTX_OPPOSITE                      0x180ED
#define HID_VSCTX_TRANSVERSE                    0x180EE
#define HID_VSCTX_NUCLEAR                       0x180EF
#define HID_VSCTX_SECONDARY                     0x180F0
#define HID_VSCTX_SPECIFIC                      0x1814C
#define HID_VSCTX_PROPERTIES                    0x181B0
...
// Resources (IDR_*) 
#define HIDR_PANE_CONVERSATION                  0x20FA0
#define HIDR_PANE_PROPERTIES                    0x20FA1
#define HIDR_PANE_CONSULTATION                  0x20FA2
#define HIDR_PANE_EXPLORATION                   0x20FA3
#define HIDR_PANE_LOGIC                         0x20FA4
#define HIDR_MAINFRAME                          0x200C8
#define HIDR_ICHING                             0x200C9
#define HIDR_LABEL_TYPE                         0x200CC
#define HIDR_SEQUENCE_TYPE                      0x200CD
#define HIDR_TEXT_TYPE                          0x200CE
#define HIDR_FIRST                              0x2012C
#define HIDR_APPLICATION                        0x2012D
#define HIDR_PREVIOUS                           0x2012E
#define HIDR_VALUESEQUENCER                     0x2012F
#define HIDR_NEXT                               0x20130
#define HIDR_LAST                               0x20131
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x200FA
#define HIDD_BELIEFBASE                         0x203E8
#define HIDD_TEXTEDIT                           0x2044C
#define HIDD_CONSULTATION_FORM                  0x204B0
#define HIDD_CONSULTATION_DLG                   0x20514
#define HIDD_EXPLORATION_FORM                   0x20578
#define HIDD_LOGIC_FORM                         0x205DC
